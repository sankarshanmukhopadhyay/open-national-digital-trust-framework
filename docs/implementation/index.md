...
```mermaid
gantt
  title Indicative ONDTF implementation roadmap
  dateFormat  YYYY-MM
  section Foundation
  Governance and legal mapping     :a1, 2027-01, 6M
  Core standards profiles          :a2, 2027-03, 8M
  section Infrastructure
  Trust registry federation        :b1, 2027-07, 10M
  Conformance laboratory           :b2, 2027-07, 8M
  section Pilots
  Two sector pilots                :c1, 2028-01, 9M
  Cross-sector pilot               :c2, 2028-07, 9M
  section Scale
  National onboarding              :d1, 2029-01, 18M
```
