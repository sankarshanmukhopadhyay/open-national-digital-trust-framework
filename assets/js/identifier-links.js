(function () {
  ...
  const pattern = /\b(?:ONDTF-[A-Z]{3}-\d{3}|CT-[A-Z]{3}-\d{3}|JRN-[A-Z]{3}-\d{3}|ROLE-[A-Z0-9]+|IM-[A-Z]{3}|(?:URI|PLT|ADV|CLAR|CAP|THR|CTL|SB|AST|THCAT|SEC|EPA|RS|INT|AS|AP|TA|TB|ADR|LIM|MPR|EVD)-\d{2,4})\b/g;
